...
Patch113: python-2.6.2-CVE-2010-1634.patch

# CVE-2010-2089: verify sizes/lengths within audioop module:
Patch114: python-2.6.2-CVE-2010-2089.patch
...
Patch115: python-2.6.2-CVE-2008-5983.patch

# rhbz:598564 (http://bugs.python.org/issue7544): fix fatal errors when
# creating threads when memory is low; adapted from upstream r79199:
Patch116: python-2.6.2-low-memory-thread-creation.patch
...
Patch118: python-2.6.2-remove-PyUnicodeDecodeError_Create-assertions-issue9058.patch
...
#
# This is a backport of upstream r73825, r73916 and r73818 from "trunk" to 2.6.5
# (rhbz#668975)
Patch127: python-2.6.5-subprocess-poll.patch

# Allow the "no_proxy" env variable to override "ftp_proxy" in urllib2, by
# ensuring that req.host is set in ProxyHandler.proxy_open() (rhbz#671343)
Patch128: python-2.6.5-urllib2-ftp-no-proxy.patch
...
%patch113 -p1 -b .CVE-2010-1634
%patch114 -p1 -b .CVE-2010-2089
%patch115 -p1 -b .CVE-2008-5983

%patch116 -p1 -b .low-memory-thread-creation

%patch117 -p0 -b .fix-expat-issue9054

%patch118 -p0 -b .remove-unicode-decode-error-assertions-issue9058
